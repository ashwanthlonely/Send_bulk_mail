...
for index, row in df.iterrows():
    ...
    subject = """EarEase Tech Webinar Registration - How to Get Started in Software Engineering to Land a High-Paying Offer""" # Subject of the email       

    body = f"""<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <p><strong>Dear {name},</strong></p>
    <p>
        Thank you for registering for our webinar, 
        <strong>"How to Get Started in Software Engineering to Land a High-Paying Offer."</strong>
    </p>
    <p>
        We are excited to have you join us as we share <strong>valuable insights</strong> and <strong>practical tips</strong> to help you kick-start your career in the tech industry.
    </p>
    <p>
    ...
    <p>
        Get ready for an <strong>engaging session</strong> led by <strong>industry experts</strong>, including:
    </p>
    <ul>
        <li><strong>Mr. Ashwanth Karibindi</strong> (Senior Data Scientist, CEO of EarEase Tech)</li>
        <li><strong>Mr. Deeptanshu Sankhwar</strong> (Project Lead, Software Engineering Expert)</li>
    </ul>
    <p>
        Feel free to share this with your <strong>friends</strong> who might benefit from this opportunity!
    </p>
